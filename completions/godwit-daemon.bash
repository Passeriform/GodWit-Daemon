_godwit-daemon() {
    ...
    case "${cmd}" in
        godwit-daemon)
            opts=" -q -v -h -V  --quiet --verbose --help --version   new regress die help"
...
complete -F _godwit-daemon -o bashdefault -o default godwit-daemon
